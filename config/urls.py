...
urlpatterns = [
    ...
    path("tickets/<uuid:pk>/ai/<uuid:analysis_id>/apply-selected/", ai_views.ticket_ai_apply_selected, name="ticket_ai_apply_selected"),
    path("tickets/<uuid:pk>/ai/<uuid:analysis_id>/feedback/", ai_views.ticket_ai_feedback, name="ticket_ai_feedback"),
    path("tickets/<uuid:pk>/ai/time-suggestion/", ai_views.ticket_ai_time_suggestion, name="ticket_ai_time_suggestion"),
    path("tickets/<uuid:pk>/ai/time-suggestions/<uuid:suggestion_id>/approve/", ai_views.ticket_ai_time_approve, name="ticket_ai_time_approve"),
    path("tickets/<uuid:pk>/ai/reply-draft/", ai_views.ticket_ai_reply_draft, name="ticket_ai_reply_draft"),
    path("tickets/<uuid:pk>/ai/reply-drafts/<uuid:draft_id>/approve/", ai_views.ticket_ai_reply_approve, name="ticket_ai_reply_approve"),
    ...
    path("organizations/<uuid:pk>/ai/briefing/", ai_views.organization_ai_briefing, name="organization_ai_briefing"),
    ...
    path("ai/audit/", ai_views.ai_audit, name="ai_audit"),
    path("ai/digest/", ai_views.workspace_ai_digest, name="workspace_ai_digest"),
    path("ai/queue-intelligence/", ai_views.workspace_ai_queue_intelligence, name="workspace_ai_queue_intelligence"),
    path("ai/time-cleanup/", ai_views.time_ai_cleanup, name="time_ai_cleanup"),
